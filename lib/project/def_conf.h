...
#define SWVer "18.07"                                   // Major.Minor Software version (use String 01.00 - 99.99 format !)

// Power Source & Battery Level
bool BattPowered = true;                                // Is the device battery powered?
#define Batt_L_Thrs 30                                  // Battery level threshold [0%-100%] (before slepping forever).
...
#define DHTPIN  5                                       // GPIO connected to DHT Data PIN. -1 means NO DHT used!
